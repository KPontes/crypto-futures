...
contract FutureContract {
    ...
    function createBuyOrder(
        ...
        createBuyOrder(keyByte, contractsAmount, margin, dealPrice, msg.value, fee);
    }
    ...
    function getBuyOrder(string key) public view returns(address, uint, uint, uint, uint) {
        bytes32 keyByte = keccak256(bytes(key));
        return (buyOrdersMap[keyByte].buyer, buyOrdersMap[keyByte].contractsAmount, buyOrdersMap[keyByte].depositedEther, buyOrdersMap[keyByte].fee, buyOrdersMap[keyByte].dealPrice);
